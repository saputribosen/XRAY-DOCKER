...
wget https://raw.githubusercontent.com/saputribosen/XRAY-DOCKER/main/updated/adddomain.sh && chmod +x adddomain.sh && ./adddomain.sh
#
...
#
#install tools/ alat
wget https://raw.githubusercontent.com/saputribosen/XRAY-DOCKER/main/install-tools.sh && chmod +x install-tools.sh && ./install-tools.sh
#
#Instal Xray 
wget https://raw.githubusercontent.com/saputribosen/XRAY-DOCKER/main/install-xray.sh && chmod +x install-xray.sh && ./install-xray.sh

#install xmenu
wget https://raw.githubusercontent.com/saputribosen/XRAY-DOCKER/main/menu/updatedll.sh && chmod +x updatedll.sh && ./updatedll.sh
#
#SELESAI
# collor status
error1="${RED} [ERROR] ${NC}"
